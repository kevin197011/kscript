...
# Class for enhancing Windows font rendering to simulate macOS appearance
class WindowsFontEnhancer
...
WindowsFontEnhancer.new.enhance if __FILE__ == $PROGRAM_NAME
